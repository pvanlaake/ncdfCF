...
This class represents a longitude axis. Its values are numeric. This
class is used for axes that represent longitudes. This class adds some
logic that is specific to longitudes, such as their range, orientation
and their meaning. (In the near future, it will also support selecting
data that crosses the 0-360 degree boundary.)
...
- [`CFAxisLongitude$new()`](#method-CFAxisLongitude-initialize)

- [`CFAxisLongitude$copy()`](#method-CFAxisLongitude-copy)

- [`CFAxisLongitude$copy_with_values()`](#method-CFAxisLongitude-copy_with_values)

- [`CFAxisLongitude$subset()`](#method-CFAxisLongitude-subset)

- [`CFAxisLongitude$append()`](#method-CFAxisLongitude-append)
...
- `from`:
  ...
  An instance of `CFAxisLongitude` whose values to append to the values
  of this axis.
...
A new `CFAxisLongitude` instance with values from this axis and the
`from` axis appended.
